...
type PortfolioPageProps = {
  siteSectionBlocks: ContentBlock[];
};

export default function PortfolioPage({ siteSectionBlocks }: PortfolioPageProps) {
  ...
  return (
    <>
      ...
      >
        ...
        {siteSectionBlocks.length > 0 && (
          <section id="site-sections" className="relative py-16 bg-white/80 dark:bg-slate-950/80">
            <div className="container mx-auto px-4">
              <ContentRenderer blocks={siteSectionBlocks} />
            </div>
          </section>
        )}
